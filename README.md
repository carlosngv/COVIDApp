...
Esta aplicación tiene como objetivo principal que un usuario pueda generar distintos análisis de información basados de un origen de datos (un archivo CSV, de Excel o entrada en formato JSON) y diferentes variables que se deberán configurar dentro del sistema según sea el ánalisis a realizar.

La aplicación deberá es capaz de poder analizar y predecir lo siguiente:
