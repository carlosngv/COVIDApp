...
# 19
def death_lastday_firstyear(df, variables, problem):
    ...
    if initial_prediction_value > prediction_value:
        description = ''' \n
        La predicción de muertes en el país de {} para su primer año año es de {} e indica que el numero de
        muertes decrece conforme pasan los días.
        '''.format(country, prediction_value)
    else:
        description = ''' \n
        La predicción de muertes en el país de {} para su primer año es de {} e indica que el numero de
