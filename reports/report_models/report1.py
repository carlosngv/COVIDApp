...
# 5
def infected_trend_country(df, variables, problem):
    ...
    if initial_prediction_value > prediction_value:
        description = ''' \n
        La tendencia de infectados en el paìs de {} para los siguientes {} días indica que el numero de
        infectados tiende a decrecer conforme pasan los días.
        '''.format(country, days_to_predict, prediction_value)
    else:
        description = ''' \n
        La tendencia de infectados en el paìs de {} para los siguientes {} días indica que el numero de
        infectados tiende a crecer conforme pasan los días.
        '''.format(country, days_to_predict, prediction_value)
