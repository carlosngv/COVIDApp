...
def death_analysis_country(df, variables, problem):
    ...
    country_param = variables[5] # Country parameter name
    ...
    if coef < 0:
        ...
        El cuál indica que el numero de muertes ha disminuido conforme pasan los días en {}. MSE = {}; RMSE = {}; R2 = {}
        '''.format(coef, country, round(mse,2),round(rmse,2),round(r2,2))
    else:
        description = ''' \n
        El coeficiente de regresión tiene un valor de: {}. \n

        El cuál indica que el numero de muertes ha incrementado conforme pasan los días en {}.  MSE = {}; RMSE = {}; R2 = {}
        '''.format(coef, country, round(mse,2),round(rmse,2),round(r2,2))
